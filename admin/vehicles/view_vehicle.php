...
<div class="container-fluid">
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-9 mb-0 border"><?= isset($mileage) ? number_format($mileage) : '' ?> KM</div>
    </div>
    <div class="d-flex w-100">
...
<div class="py-3 text-right">
    ...
    <button class="btn btn-sm btn-flat btn-light bg-gradient-light border" data-dismiss="modal" type="button"><i class="fa fa-close"></i> عودة</button>
</div>
<script>
	$(function(){
