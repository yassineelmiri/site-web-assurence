...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">قائمة المركبات المتوفرة </h3>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="">
								<div style="line-height:1em">
									<div><b>رقم السيارة: <?= $row['mv_number'] ?></b></div>
									<div><small class="text-muted">رقم الوحة #: <?= $row['plate_number'] ?></small></div>
								</div>
							</td>
							<td class="text-right"><?= number_format($row['price'], 2) ?> $</td>
							<td align="center" class='text-center'>
								<a class="btn btn-flat btn-light bg-gradient-light btn-sm border sell_vehicle" href="./?page=vehicles/sell_vehicle&id=<?= $row['id'] ?>"><i class="far fa-handshake"></i> بيع السيارة</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
