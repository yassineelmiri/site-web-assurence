	...
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nom court</label>
			...
			<div class="form-group">
				<label for="" class="control-label">image d'arrière-plan</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile2" name="cover" onchange="displayImg2(this,$(this))">
	              <label class="custom-file-label" for="customFile2">télécharger</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
			...
			<div class="form-group">
				<label for="" class="control-label">Image de l'interface</label>
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">télécharger</label>
	            </div>
				<small><i> Choisissez de télécharger une nouvelle image</i></small>
			</div>
			<?php 
...
<script>
	...
	function delete_img($path){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("Une erreur s'est produite lors de la suppression de l'image","error");
                end_loader()
            },
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    alert_toast("L'image a été supprimée avec succès.","success");
                }else{
                    console.log(resp)
                    alert_toast("Une erreur s'est produite lors de la suppression de l'image","error");
                }
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("Êtes-vous sûr de vouloir supprimer ceci ?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
