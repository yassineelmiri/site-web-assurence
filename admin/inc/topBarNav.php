      ...
      <nav class="main-header navbar navbar-expand navbar-light shadow text-sm">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo base_url ?>" >Responsable</a>
          </li>
        </ul>
        <!-- Right navbar links -->
          ...
          <li class="nav-item">
            <div class="btn-group nav-link">
                  ...
                  <div class="dropdown-menu" role="menu">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url.'/classes/Login.php?f=logout' ?>"><span class="fas fa-sign-out-alt"></span> EXIT</a>
                  </div>
              </div>
          </li>
          <li class="nav-item">
