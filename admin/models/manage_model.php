...
<div class="content py-5 px-3 bg-gradient-navy">
	<h4 class="font-wight-bolder"><?= isset($id) ? "Mettre à jour les détails" : "ajouter une nouvelle Article" ?></h4>
</div>
	...
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
					...
					<form action="" id="model-form">
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="brand_id" class="control-label">Assurence</label>
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="car_type_id" class="control-label"> type article </label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="model" class="control-label">reclamation</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="engine_type" class="control-label">Type de accident</label>
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="transmission_type" class="control-label"> Type de pertes</label>
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<label for="technology" class="control-label">Caractéristiques</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="status" class="control-label">la condition</label>
								<select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
									<option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Disponible</option>
									<option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Non disponible</option>
								</select>
							</div>
						</div>
					</form>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-flat btn-sm btn-navy bg-gradient-navy" form="model-form"><i class="fa fa-save"></i> sauvegarder</button>
				<?php if(isset($id)): ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models/view_model&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-angle-left"></i> annulation</a>
				<?php else: ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models"><i class="fa fa-angle-left"></i> annulation</a>
				<?php endif; ?>
			</div>
		</div>
	</div>
...
<script>
	$(document).ready(function(){
		...
		$('#car_type_id').select2({
			placeholder:"Veuillez sélectionner type de article",
			width:'100%',
			containerCssClass:'form-control form-control-sm rounded-0'
		})
