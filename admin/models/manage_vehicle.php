    ...
    <form action="" id="vehicle-form">
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mv_number" class="control-label">Nember de Article</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="plate_number" class="control-label">Numéro de plaque</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="engine_number" class="control-label">Numéro de Assurence</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="chasis_number" class="control-label">>Numéro de sepiciale</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="variant" class="control-label">Color de Article</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mileage" class="control-label">Mètres</label>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="status" class="control-label">le SITUATION</label>
                <select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
                    <option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Disponible </option>
                    <option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Non Disponible </option>
                </select>
            </div>
        </div>
    </form>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						uni_modal('<i class="fa fa-th-list"></i>  detail de article', 'models/view_vehicle.php?id='+resp.vid)
